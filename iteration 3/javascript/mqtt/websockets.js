...
function sendMessage() {
  ...
  // Construct message
  const payload = `'${sender}'${msgDelimiter}'${moment().format('llll').replace(/,/g, ' ')}'${msgDelimiter}'${carbrand}'${msgDelimiter}'${engine}'${msgDelimiter}'${bodytype}'${msgDelimiter}'${rating}'${msgDelimiter}'${price}'${msgDelimiter}'`;
